    ...
    def train(self):
        ...
        for iteration in tqdm(range(start_iter, self.max_iter + 1)):
            ...
            if iteration % iter_per_epoch == 0:
                ...
                epoch_traj_loss /= iter_per_epoch
                writer.add_scalar('traj_loss_epoch', epoch_traj_loss.item(), epoch)
            ...
            writer.add_scalar('traj_loss_batch', traj_elbo.item(), iteration)
            epoch_traj_loss += traj_elbo.item()
